...
class _homeWithSidebarState extends State<homeWithSidebar>
  ...
  late AnimationController rotationCotroller;
  @override
  void initState() {
    super.initState();
    rotationCotroller =
        ...
        children: [
                          ...
                          Container(
                            ...
                            decoration: const BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: AssetImage('asset/images/avatar2.png'),
                                fit: BoxFit.contain,
                              ),
                            ),
                          ),
          ...
          AnimatedPositioned(
            ...
            child: RotationTransition(
              turns: (sideBarActive)
                  ? Tween(begin: -0.05, end: 0.0).animate(rotationCotroller)
                  : Tween(begin: 0.0, end: -0.05).animate(rotationCotroller),
